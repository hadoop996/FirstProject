...
/**
 * @author 郝少杰
 * @date 2021/4/29 11:50
 */
public class AesUtilsIDCard {
    ...
    public static void main(String[] args) throws Exception {
        //测试密钥
        String secret = "WXwkV7j5LCEIMFV0";
//        //待加密内容
//        String content = "131081197810101031";
//        System.out.println(content);
//        //加密
//        String encrypt = encrypt(content,secret);
//        System.out.println(encrypt);
        //解密
        String a = "f745cc5507e068ac96d5dbeab4cb88f57e8f9e07c6deee3b149ba108ffd3a226";
